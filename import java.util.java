...
public class App {
    public static void main(String[] args) throws Exception {
        Student s1 = new Student("Петр", 24);
        Student s2 = new Student("Иван", 22);
        Student s3 = new Student("Александр", 22);
        Student s4 = new Student("Егор", 23);
        Student s5 = new Student("Ольга", 23);
        Student s6 = new Student("Едена", 23);
        ...
        System.out.println();
        System.out.println(
                "Вывод StudentSteam.forEach() + StudentGroup.toString() =========================================================");
        ...
        System.out.println();
        System.out.println(
                "Вывод StudentSteam.toString() после сортировки =========================================================");
        System.out.println(steam1);

        steam1.sortSteam();
        System.out.println();
        System.out.println(
                "Вывод StudentSteam.toString() после сортировки групп и студентов в них =========================================================");
        System.out.println(steam1);

        Teacher t1 = new Teacher("Ирина", 51, "Docent");
        Teacher t2 = new Teacher("Ольга", 52, "Docent");
